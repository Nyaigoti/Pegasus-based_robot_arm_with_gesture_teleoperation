...
bool hand_interfaces__msg__finger_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hand_interfaces.msg._finger_data.FingerData", full_classname_dest, 43) == 0);
  }
  hand_interfaces__msg__FingerData * ros_message = _ros_message;
  {  // x
...
PyObject * hand_interfaces__msg__finger_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hand_interfaces.msg._finger_data");
