...
#include "hand_interfaces/msg/detail/finger_data__rosidl_typesupport_fastrtps_c.h"
...
using _FingerData__ros_msg_type = hand_interfaces__msg__FingerData;
  ...
  void * untyped_ros_message)
{
  ...
  _FingerData__ros_msg_type * ros_message = static_cast<_FingerData__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _FingerData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hand_interfaces__msg__FingerData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hand_interfaces__msg__FingerData;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _FingerData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hand_interfaces__msg__FingerData(
