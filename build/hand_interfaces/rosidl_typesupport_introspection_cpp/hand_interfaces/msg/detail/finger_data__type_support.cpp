...
{
  new (message_memory) hand_interfaces::msg::FingerData(_init);
}

void FingerData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<hand_interfaces::msg::FingerData *>(message_memory);
  typed_message->~FingerData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember FingerData_message_member_array[2] = {
  {
    "x",  // name
    ...
    offsetof(hand_interfaces::msg::FingerData, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hand_interfaces::msg::FingerData, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers FingerData_message_members = {
  ...
  2,  // number of fields
  sizeof(hand_interfaces::msg::FingerData),
...
{
  return &::hand_interfaces::msg::rosidl_typesupport_introspection_cpp::FingerData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hand_interfaces, msg, FingerData)() {
  return &::hand_interfaces::msg::rosidl_typesupport_introspection_cpp::FingerData_message_type_support_handle;
}
